...
// ----------------------------  CONFIG DB  ----------------------------- //
$_config['db']['1']['dbhost'] = $_SERVER['SINASRV_DB_HOST'];
$_config['db']['1']['dbuser'] = $_SERVER['SINASRV_DB_USER'];
$_config['db']['1']['dbpw'] = $_SERVER['SINASRV_DB_PASS'];
$_config['db']['1']['dbcharset'] = 'utf8';
$_config['db']['1']['pconnect'] = '0';
$_config['db']['1']['dbname'] = $_SERVER['SINASRV_DB_NAME'];
$_config['db']['1']['tablepre'] = 'hey_';
$_config['db']['slave'] = '';
$_config['db']['common']['slave_except_table'] = '';

// --------------------------  CONFIG MEMORY  --------------------------- //
$_config['memory']['prefix'] = 'SF3CO3_';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'DXxz_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '5d7d36TQ1N86uCYI';
